...
from lfxai.models.efficient_vdvae.layers import LevelBlockUp, LevelBlockDown
from lfxai.models.efficient_vdvae.utils import one_hot, compute_latent_dimension, scale_pixels
...
class UniversalAutoEncoder(nn.Module):
    def __init__(self, encoder: BottomUp, decoder: TopDown):
        super(UniversalAutoEncoder, self).__init__()

        self.bottom_up = encoder
        self.top_down = decoder
