...
from lfxai.models.efficient_vdvae.autoencoder import (
    TopDown,
    BottomUp,
...
def pretext_task_sensitivity(
    ...
    for run in range(n_runs):
        ...
        encoder = BottomUp()
        decoder = TopDown()
        model = UniversalAutoEncoder(encoder, decoder)
        feat, example = fit_and_calc_importance(name, True, encoder, model)
        feature_importance.append(feat)
        example_importance.append(example)
